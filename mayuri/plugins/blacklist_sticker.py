...
async def rm_bl(c, m):
    ...
    if check:
        ...
        await m.reply_text(
            (await c.tl(chat_id, "blsticker_deleted")).format(stickerid),
            disable_web_page_preview=True,
        )
    else:
        await m.reply_text(
            (await c.tl(chat_id, "blsticker_not_found")).format(stickerid),
            disable_web_page_preview=True,
        )
